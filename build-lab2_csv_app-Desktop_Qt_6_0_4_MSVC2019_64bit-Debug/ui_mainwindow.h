...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(1033, 513);
        MainWindow->setMinimumSize(QSize(1033, 513));
        MainWindow->setMaximumSize(QSize(1033, 513));
        ...
        txt_column->setGeometry(QRect(290, 80, 81, 41));
        txt_column->setFont(font);
        txt_column->setTabletTracking(false);
