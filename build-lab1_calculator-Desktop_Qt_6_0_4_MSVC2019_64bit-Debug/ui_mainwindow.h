...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(312, 624);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(MainWindow->sizePolicy().hasHeightForWidth());
        MainWindow->setSizePolicy(sizePolicy);
        MainWindow->setMinimumSize(QSize(312, 624));
        MainWindow->setMaximumSize(QSize(312, 624));
        QFont font;
        ...
        btn_0->setGeometry(QRect(20, 540, 131, 61));
        btn_2 = new QPushButton(centralwidget);
        btn_2->setObjectName(QString::fromUtf8("btn_2"));
        btn_2->setGeometry(QRect(90, 470, 61, 61));
        btn_1 = new QPushButton(centralwidget);
        btn_1->setObjectName(QString::fromUtf8("btn_1"));
        btn_1->setGeometry(QRect(20, 470, 61, 61));
        btn_result = new QPushButton(centralwidget);
        btn_result->setObjectName(QString::fromUtf8("btn_result"));
        btn_result->setGeometry(QRect(230, 470, 61, 131));
        btn_3 = new QPushButton(centralwidget);
        btn_3->setObjectName(QString::fromUtf8("btn_3"));
        btn_3->setGeometry(QRect(160, 470, 61, 61));
        btn_point = new QPushButton(centralwidget);
        btn_point->setObjectName(QString::fromUtf8("btn_point"));
        btn_point->setGeometry(QRect(160, 540, 61, 61));
        btn_8 = new QPushButton(centralwidget);
        btn_8->setObjectName(QString::fromUtf8("btn_8"));
        btn_8->setGeometry(QRect(90, 330, 61, 61));
        btn_6 = new QPushButton(centralwidget);
        btn_6->setObjectName(QString::fromUtf8("btn_6"));
        btn_6->setGeometry(QRect(160, 400, 61, 61));
        btn_minus = new QPushButton(centralwidget);
        btn_minus->setObjectName(QString::fromUtf8("btn_minus"));
        btn_minus->setGeometry(QRect(230, 330, 61, 61));
        btn_9 = new QPushButton(centralwidget);
        btn_9->setObjectName(QString::fromUtf8("btn_9"));
        btn_9->setGeometry(QRect(160, 330, 61, 61));
        btn_plus = new QPushButton(centralwidget);
        btn_plus->setObjectName(QString::fromUtf8("btn_plus"));
        btn_plus->setGeometry(QRect(230, 400, 61, 61));
        btn_5 = new QPushButton(centralwidget);
        btn_5->setObjectName(QString::fromUtf8("btn_5"));
        btn_5->setGeometry(QRect(90, 400, 61, 61));
        btn_7 = new QPushButton(centralwidget);
        btn_7->setObjectName(QString::fromUtf8("btn_7"));
        btn_7->setGeometry(QRect(20, 330, 61, 61));
        btn_4 = new QPushButton(centralwidget);
        btn_4->setObjectName(QString::fromUtf8("btn_4"));
        btn_4->setGeometry(QRect(20, 400, 61, 61));
        btn_delete = new QPushButton(centralwidget);
        btn_delete->setObjectName(QString::fromUtf8("btn_delete"));
        btn_delete->setGeometry(QRect(90, 260, 61, 61));
        btn_divide = new QPushButton(centralwidget);
        btn_divide->setObjectName(QString::fromUtf8("btn_divide"));
        btn_divide->setGeometry(QRect(160, 260, 61, 61));
        btn_clear = new QPushButton(centralwidget);
        btn_clear->setObjectName(QString::fromUtf8("btn_clear"));
        btn_clear->setGeometry(QRect(20, 260, 61, 61));
        btn_mult = new QPushButton(centralwidget);
        btn_mult->setObjectName(QString::fromUtf8("btn_mult"));
        btn_mult->setGeometry(QRect(230, 260, 61, 61));
        lbl_main = new QLabel(centralwidget);
        lbl_main->setObjectName(QString::fromUtf8("lbl_main"));
        lbl_main->setGeometry(QRect(10, 10, 291, 141));
        QFont font1;
        font1.setPointSize(18);
        lbl_main->setFont(font1);
        lbl_main->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        btn_werewolf = new QPushButton(centralwidget);
        btn_werewolf->setObjectName(QString::fromUtf8("btn_werewolf"));
        btn_werewolf->setGeometry(QRect(90, 210, 61, 41));
        QFont font2;
        font2.setPointSize(15);
        btn_werewolf->setFont(font2);
        btn_sqrt = new QPushButton(centralwidget);
        btn_sqrt->setObjectName(QString::fromUtf8("btn_sqrt"));
        btn_sqrt->setGeometry(QRect(160, 210, 61, 41));
        QFont font3;
        font3.setPointSize(13);
        btn_sqrt->setFont(font3);
        btn_swap = new QPushButton(centralwidget);
        btn_swap->setObjectName(QString::fromUtf8("btn_swap"));
        btn_swap->setGeometry(QRect(20, 210, 61, 41));
        btn_swap->setFont(font2);
        btn_mc = new QPushButton(centralwidget);
        btn_mc->setObjectName(QString::fromUtf8("btn_mc"));
        btn_mc->setGeometry(QRect(20, 160, 61, 41));
        btn_mc->setFont(font2);
        btn_mr = new QPushButton(centralwidget);
        btn_mr->setObjectName(QString::fromUtf8("btn_mr"));
        btn_mr->setGeometry(QRect(90, 160, 61, 41));
        btn_mr->setFont(font2);
        btn_m_plus = new QPushButton(centralwidget);
        btn_m_plus->setObjectName(QString::fromUtf8("btn_m_plus"));
        btn_m_plus->setGeometry(QRect(160, 160, 61, 41));
        btn_m_plus->setFont(font2);
        btn_m_minus = new QPushButton(centralwidget);
        btn_m_minus->setObjectName(QString::fromUtf8("btn_m_minus"));
        btn_m_minus->setGeometry(QRect(230, 160, 61, 41));
        btn_m_minus->setFont(font2);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btn_werewolf->setText(QCoreApplication::translate("MainWindow", "1/x", nullptr));
        btn_sqrt->setText(QCoreApplication::translate("MainWindow", "sqrt(x)", nullptr));
        btn_swap->setText(QCoreApplication::translate("MainWindow", "+/-", nullptr));
